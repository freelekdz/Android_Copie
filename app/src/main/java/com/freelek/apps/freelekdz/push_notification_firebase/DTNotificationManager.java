...
import com.freelek.apps.freelekdz.dtmessenger.InComingDataParserSender;
import com.freelek.apps.freelekdz.utils.NotificationUtils;
...
public class DTNotificationManager {
    ...
    public void parse(String incomingData) {
        ...
        if (AppConfig.APP_DEBUG)
            Log.e(FirebaseMessagingServiceIns.TAG, data.toString());
        ...
        if (mParser.getType().equals(Parser.OFFER)) {
            ...
            if (AppConfig.APP_DEBUG && mParser.getBody() != null)
                Log.e(FirebaseMessagingServiceIns.TAG, mParser.getBody().toString());
            ...
            if (AppConfig.APP_DEBUG)
                Log.e(FirebaseMessagingServiceIns.TAG, mParser.toString());
